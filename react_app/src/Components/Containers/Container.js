  ...
  return (
    <div>
      ...
      {(currentPlant && apicall) ? (
        ...
        (<div style={{ textAlign: "center" }}><h1>{`CRV app is undergoing maintenance and will be operational shortly. We apologize for any inconvenience caused.`}</h1></div>)//loading....${noData}
